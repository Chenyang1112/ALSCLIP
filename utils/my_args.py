...
def my_args():
    ...
    parser.add_argument('--neptune_proj', type=str, default=None, required=False)
    parser.add_argument('--print_freq', type=int, default=1)
    parser.add_argument('--neptune_id', type=str, default=None)
    parser.add_argument('--neptune_key', type=str, default="eyJhcGlfYWRkcmVzcyI6Imh0dHBzOi8vYXBwLm5lcHR1bmUuYWkiLCJhcGlfdXJsIjoiaHR0cHM6Ly9hcHAubmVwdHVuZS5haSIsImFwaV9rZXkiOiI0MjI2MzRhYy0xOGViLTRhMWMtOTg1MS01MWY0NTg2ZDkxODEifQ==")
