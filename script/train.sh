...
S3DIS=./DFC2019_train # your dataset path
SAVEROOT="<ROOT>/DFC2019/indoor_segmentation/output"
...
python train_pl.py \
  ...
  --epochs 32  --CHECKPOINT_PERIOD 1  --lr 0.1 \
  ...
  \
  --voxel_size 0.5  --eval_voxel_max 800000  --test_batch 8 --cudnn_benchmark False
